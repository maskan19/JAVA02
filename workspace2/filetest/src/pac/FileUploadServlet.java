...
public class FileUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String uploadPath = "c:/users/pc-25/desktop";
		 ...
		 * 2. request.getParts("part이름"); : 지정한 이름을 가진 개별 Part객체를 반환한다.
		 */
...
//		doGet(request, response);
	 ...
	 * Part객체의 구조
	 * 1) 파일이 아닌 경우
	 * ----------------------WEBZDF465WEGTYRHFWE456 					 : Part를 구분하는 구분선
	 * Content-Disposition: form-data: name="age"   					 : Parameter명(헤더 정보)
	 * 																	 : 빈 줄
	 * 30																 : Parameter값
	 * 
	 * 2) 파일인 경우
	 * ----------------------WEBZDF465WEGTYRHFWE456 					 : Part를 구분하는 구분선
	 * Content-Disposition: form-data: name="file1"; filename="test1.txt" : Parameter명(헤더 정보)
	 * contetn-Type: text/plain											 : 파일의 종류
	 * 																	 : 빈 줄
	 * 안녕하세요RULKH1328E93XC32OI5;46I5;OF6W4EF5W1F23EW					 : 파일의 내용
	 * 
	 */
